label part2_sister_garcia:
    call suspicion(10, "death_crown_of_thorns") from _call_suspicion_47
    menu:
        ...
        "Tell me about how you got her plant again.":
            call suspicion(25, "death_crown_of_thorns") from _call_suspicion_48
            show vivienne angry_armup
            ...
            menu:
                ...
                "I remember her name from the cold case files.":
                    call suspicion(-10) from _call_suspicion_49
                    ...
                    menu:
                        ...
                        "I may be stupid. But at least I know a cold case means the person was never declared dead.":
                            call suspicion(100, "death_crown_of_thorns") from _call_suspicion_50
                        "I may be smarter than you.":
                            call suspicion(-10) from _call_suspicion_51
                ...
                "I reported on her disappearance when she never returned to the church.":
                    call suspicion(25, "death_crown_of_thorns") from _call_suspicion_52
                    show vivienne angry_armup
